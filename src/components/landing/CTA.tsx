...
export default function CTA() {
  return (
    <section className="relative overflow-hidden bg-[#08080a] py-20 sm:py-28">
      <div className="absolute left-1/2 top-1/2 h-[380px] w-[380px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#8b5cf6]/10 blur-[140px] pointer-events-none" />
      ...
      <Container>
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0d1017] p-8 sm:p-14 backdrop-blur-xl shadow-2xl"
        >
          <div className="mx-auto max-w-3xl text-center space-y-6">
            ...
            <p className="mx-auto max-w-xl text-sm leading-relaxed text-zinc-400">
              Stop wasting hours trapped in chatbot blame loops. Connect your dispute and let the autonomous agent handle logistics overrides, payment audits, and statutory escalations.
            </p>
            ...
            <div className="pt-2 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              >
                <Bot size={15} />
                <span>DEPLOY DISPUTE AGENT</span>
                <ArrowRight size={14} />
              </Link>
